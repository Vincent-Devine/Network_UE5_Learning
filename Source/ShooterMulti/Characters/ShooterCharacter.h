...
protected:
	...
	UFUNCTION(Server, Reliable) void ServerUpdateAimOffsets(float newAimPitch, float newAimYaw);
...
public:
	...
	// Punch
	UFUNCTION(Server, Reliable, WithValidation) void ServerPunch();
	UFUNCTION(NetMulticast, Reliable, WithValidation) void MultiCastPunch();

	// PushButtton
	UFUNCTION(Server, Reliable, WithValidation) void ServerPushButton();
	UFUNCTION(NetMulticast, Reliable, WithValidation) void MultiCastPushButton();

	// SetTeam
	UFUNCTION(Server, Reliable, WithValidation) void ServerSetTeam(ETeam InTeam);
	UFUNCTION(NetMulticast, Reliable, WithValidation) void MultiCastServerSetTeam(ETeam InTeam);

	// SetInvincibility
	UFUNCTION(Server, Reliable, WithValidation) void ServerSetInvincibility();
	UFUNCTION(NetMulticast, Reliable, WithValidation) void MultiCastServerSetInvincibility();
};