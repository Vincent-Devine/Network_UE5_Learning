...
bool UWeaponComponent::ShootLaser(AActor* Causer, FHitResult& HitResult, const FLaserWeaponData& WeaponData)
{
												...
												ECC_Visibility , CollisionParams))
	{
		...
		if(GetOwner()->GetLocalRole() == ROLE_AutonomousProxy)
			ServerTakeDamage(Causer, HitResult, WeaponData, LookDirection);
...
void UWeaponComponent::ServerTakeDamage_Implementation(AActor* Causer, const FHitResult& HitResult, const FLaserWeaponData& WeaponData, FVector LookDirection)
{
	MultiCastTakeDamage(Causer, HitResult, WeaponData, LookDirection);
}

bool UWeaponComponent::ServerTakeDamage_Validate(AActor* Causer, const FHitResult& HitResult, const FLaserWeaponData& WeaponData, FVector LookDirection)
{
	return true;
}

void UWeaponComponent::MultiCastTakeDamage_Implementation(AActor* Causer, const FHitResult& HitResult, const FLaserWeaponData& WeaponData, FVector LookDirection)
{
	FPointDamageEvent DamageEvent = FPointDamageEvent(WeaponData.Damages, HitResult, LookDirection, UDamageTypeRifle::StaticClass());
	HitResult.GetActor()->TakeDamage(WeaponData.Damages, DamageEvent, nullptr, Causer);
}

bool UWeaponComponent::MultiCastTakeDamage_Validate(AActor* Causer, const FHitResult& HitResult, const FLaserWeaponData& WeaponData, FVector LookDirection)
{
	return true;
}