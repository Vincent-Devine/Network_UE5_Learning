...
protected:
	...
	void ServerTakeDamage(AActor* Causer, const FHitResult& HitResult, const FLaserWeaponData& WeaponData, FVector LookDirection);
	
	UFUNCTION(NetMulticast, Reliable, WithValidation)
	void MultiCastTakeDamage(AActor* Causer, const FHitResult& HitResult, const FLaserWeaponData& WeaponData, FVector LookDirection);
